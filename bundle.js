...
/***/ function(module, exports, __webpack_require__) {
	...
	var stripeEvents = __webpack_require__(34);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var onUpdateItem = function onUpdateItem(event) {
	  ...
	  var data = { item: { count: 4 } };
	  console.log('I\'m UPDATED itemId and countData', itemId, data);
	  debugger;
	  api.updateItem(itemId, data).then(ui.updateItemSuccess).catch(ui.updateItemFailure);
	};

	var onDeleteItem = function onDeleteItem() {
	  var id = event.target.getAttribute('data-id');
	  console.log('DELETED', id);
	  api.deleteItem(id).then(ui.deleteItemSuccess).catch(ui.deleteItemFailure);
	};
	...
	var onGetAllProducts = function onGetAllProducts(data) {
	  // event.preventDefault();
	  console.log('You have ALL products.');
	  api.getAllProducts(data).then(ui.getAllProductsSuccess).then(function () {
	    $('.prod-desc').on('click', onGetOneProduct);
	  }).catch(ui.getAllProductsFailure);
	};

	var onGetOrderHx = function onGetOrderHx() {};
...
/***/ function(module, exports, __webpack_require__) {
	...
	var store = __webpack_require__(7);
	var showAllProductsTemplate = __webpack_require__(12);

	var showOneProductTemplate = __webpack_require__(32);
	var cartTemplate = __webpack_require__(33);
	...
	var addItemFailure = function addItemFailure() {
	  console.log('FAIL!');
	};
...
/***/ function(module, exports, __webpack_require__) {
	...
	module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data,blockParams) {
	  ...
	  return "    <div class=\"row\" data-id="
	    ...
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.name : stack1), depth0))
	    + "</p>\n      </div>\n      <div class=\"col-md-3 cart-item-price\">\n        <p>$"
	    ...
	    + " name=\"item[count]\">\n            <button type=\"submit\" class=\"update-cart-item\">Update Item Quantity "
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " </button>\n          </div>\n        </form>\n      </div>\n      <div class=\"col-md-3\">\n        <button type=\"button\" data-id="
	    + alias2(alias1(((stack1 = blockParams[0][0]) != null ? stack1.id : stack1), depth0))
	    + " class=\"delete-cart-item\">Delete Item from Cart </button>\n        <br>\n      </div>\n    </div>\n";
	},"compiler":[7,">= 4.0.0"],"main":function(container,depth0,helpers,partials,data,blockParams) {
	    var stack1;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var cart = __webpack_require__(37);
